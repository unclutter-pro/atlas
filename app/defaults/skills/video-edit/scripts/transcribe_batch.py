...
from transcribe import load_api_key, transcribe_one, transcript_path, source_identity, cached_transcript
...
def main() -> None:
    ...
    already_cached = [v for v in videos
                      if cached_transcript(transcript_path(edit_dir, v, args.audio_track),
                                           source_identity(v, args.audio_track, args.language, args.num_speakers))]
