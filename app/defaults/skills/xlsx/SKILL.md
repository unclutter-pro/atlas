---
name: xlsx
description: Create, edit, or analyze spreadsheets and tabular files while preserving cells, formulas and data types. For a plain text summary of a document, use document-parse.
