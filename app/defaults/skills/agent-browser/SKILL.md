...
allowed-tools: Bash(npx agent-browser:*), Bash(agent-browser:*), Bash(browser:*)
---

# Browser Automation with agent-browser

The CLI uses Chrome/Chromium via CDP directly. A `browser` shortcut is available as an alias for `agent-browser` — both work identically.
